...
// Create developer user (full access)
  ...
  if (roomTypeCount === 0) {
    const roomTypes = [
      ...
      {
        name: 'Suite',
        description: 'Luxury suite with living area and premium views',
        baseRate: 45000,
        maxOccupancy: 4,
      ...
      {
        name: 'Presidential',
        description: 'Exclusive presidential suite with full luxury amenities',
        baseRate: 80000,
        maxOccupancy: 6,
  ...
  if (roomCount === 0) {
    ...
    const presidential = roomTypes.find((r) => r.name === 'Presidential');

    const rooms = [
      // Floor 1
      { roomNumber: '101', floor: 1, roomTypeId: standard!.id, status: 'available' },
      { roomNumber: '102', floor: 1, roomTypeId: standard!.id, status: 'occupied' },
      { roomNumber: '103', floor: 1, roomTypeId: deluxe!.id, status: 'available' },
      { roomNumber: '104', floor: 1, roomTypeId: deluxe!.id, status: 'housekeeping' },
      { roomNumber: '105', floor: 1, roomTypeId: standard!.id, status: 'available' },
      { roomNumber: '106', floor: 1, roomTypeId: suite!.id, status: 'reserved' },
      { roomNumber: '107', floor: 1, roomTypeId: standard!.id, status: 'available' },
      // Floor 2
      { roomNumber: '201', floor: 2, roomTypeId: deluxe!.id, status: 'available' },
      { roomNumber: '202', floor: 2, roomTypeId: standard!.id, status: 'occupied' },
      { roomNumber: '203', floor: 2, roomTypeId: suite!.id, status: 'available' },
      { roomNumber: '204', floor: 2, roomTypeId: deluxe!.id, status: 'maintenance' },
      { roomNumber: '205', floor: 2, roomTypeId: standard!.id, status: 'available' },
      { roomNumber: '206', floor: 2, roomTypeId: deluxe!.id, status: 'occupied' },
      { roomNumber: '207', floor: 2, roomTypeId: suite!.id, status: 'available' },
      // Floor 3
      { roomNumber: '301', floor: 3, roomTypeId: suite!.id, status: 'available' },
      { roomNumber: '302', floor: 3, roomTypeId: presidential!.id, status: 'available' },
      { roomNumber: '303', floor: 3, roomTypeId: suite!.id, status: 'occupied' },
      { roomNumber: '304', floor: 3, roomTypeId: deluxe!.id, status: 'available' },
      { roomNumber: '305', floor: 3, roomTypeId: presidential!.id, status: 'reserved' },
      { roomNumber: '306', floor: 3, roomTypeId: suite!.id, status: 'available' },
    ];
