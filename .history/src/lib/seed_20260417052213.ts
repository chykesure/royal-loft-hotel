...
export async function seedDatabase() {
  ...
  if (roomTypeCount === 0) {
    ...
    console.log('Room types created (Standard N30K, Deluxe N40K, Executive N50K, Executive Suite N65K)');
  }
  ...
  if (roomCount === 0) {
    ...
    const rooms = [
      // Standard rooms (N30,000/night) - 5 rooms
      ...
      // Deluxe rooms (N40,000/night) - 2 rooms
      ...
      // Executive rooms (N50,000/night) - 7 rooms
      ...
      // Executive Suite rooms (N65,000/night) - 2 rooms
  ...
  if (policyCount === 0) {
    const policies = [
      ...
      { title: 'Payment Policy', description: 'All payments must be made in Nigerian Naira (N). We accept Cash, POS/Card, Bank Transfer, OPay, PalmPay, and Moniepoint. A valid ID may be required for transactions.', category: 'payment', sortOrder: 3 },
      ...
      { title: 'No Smoking Policy', description: 'All indoor areas are strictly non-smoking. A cleaning fee of N50,000 will be charged for smoking in rooms. Designated smoking areas are available outside the building.', category: 'smoking', sortOrder: 5 },
  ...
  console.log('Next step: Run "node scripts/migrate-legacy-data.js" to import guests and bookings from your old system.');
}
